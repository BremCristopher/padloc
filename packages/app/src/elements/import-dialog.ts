...
const fieldTypeOptions: { label: string; value: FieldType | "skip" }[] = (
    Object.keys(FIELD_DEFS) as (keyof typeof FIELD_DEFS)[]
).map((fieldType) => ({
                            ...
                            (itemColumn, itemColumnIndex) => html`
                                ...
                                >
                                    ...
                                    <pl-select
                                        ...
                                        icon=${FIELD_DEFS[itemColumn.type as FieldType]?.icon || "text"}
                                        .label=${$l("Field Type")}
